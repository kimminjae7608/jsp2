...
<body>
<div>http 프로토콜은 stateless(상태정보유지안됨), 비연결 <br>
	 ...
	 -> 세션 유효시간 변경 방법<br>
	 	...
	 	: 소스 코드에서 메소드 실행해서 바꿀 수 있습니다.(단위:초) <br>
</div>
<%
	...
	out.print("세션 생성시간 long : "+start);				//시간이 long일때는 1970년 1월1일 을 시작으로 ms 단위
	out.print("<br>");
	DateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
	out.print("세션 생성시간 : "+df.format(start));
	out.print("<br>");

	int exp =session.getMaxInactiveInterval();
